...
public class History {
	public int start; // this is the index of the first word of the sentence
	public int end; //this is the index of the last word in the sentence - the dot
	public int current; // this is the index of the current word
	...
	public History(int start, int end, int current, PairsHolder pairs, Extractors extractors) {
		this.pairs = pairs;
		this.extractors = extractors;
	...
	/*
	 * public void save(DataOutputStream rf) { try { rf.writeInt(start);
	 * rf.writeInt(end); rf.writeInt(current); } catch (Exception e) {
	 * e.printStackTrace(); } }
	 * 
	 * 
	 * public void read(InDataStreamFile rf) { try { start = rf.readInt(); end =
	 * rf.readInt(); current = rf.readInt(); } catch (Exception e) {
	 * e.printStackTrace(); } }
	 */
