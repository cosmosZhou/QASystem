...
public class TestSentence implements SequenceModel {
	 ...
	 *
	 * @param probabilities
	 *            Array with indices sent size, k best size, numTags
	 */
	...
	/**
	 * This method should be called after the sentence has been tagged. For
	 * every unknown word, this method prints the 3 most probable tags to the
	 * file pfu.
	 *
	 * @param numSent
	 *            The sentence number
	 * @param pfu
	 *            The file to print the probable tags to
	 */
	...
	/**
	 * probs and tags should be passed in as arrays of size 3! If probs[i] ==
	 * Double.NEGATIVE_INFINITY, then the entry should be ignored.
	 */
	...
	public String toString() {
		...
		str += "localScores = ";
		str += Utility.toString(localScores, Utility.lineSeparator);
		str += Utility.lineSeparator;

		str += "localContextScores = ";
		str += Utility.toString(localContextScores, ",", null, localContextScores.length);
