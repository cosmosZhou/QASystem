...
/**
 * Check tag of each character from 5 different corpora. (4 official training
 * corpora of Sighan bakeoff 2005, plus CTB) These tags are not external
 * knowledge. They are learned from the training corpora.
 * 
 * @author Huihsin Tseng
 * @author Pichuan Chang
 */
public class CorpusChar implements Serializable {
	private static final long serialVersionUID = -9128619084259889057L;
	...
	/*
	 * public String getCtbTag(String a1, String a2) { HashMap h1=dict.getctb();
	 * Set h2=(Set)h1.get(a1); if (h2 == null) return "0"; if (h2.contains(a2))
	 * return "1"; return "0"; }
	 * 
	 * public String getAsbcTag(String a1, String a2) { HashMap
	 * h1=dict.getasbc(); Set h2=(Set)h1.get(a1); if (h2 == null) return "0"; if
	 * (h2.contains(a2)) return "1"; return "0"; }
	 * 
	 * public String getPkuTag(String a1, String a2) { HashMap h1=dict.getpku();
	 * Set h2=(Set)h1.get(a1); if (h2 == null) return "0"; if (h2.contains(a2))
	 * return "1"; return "0"; }
	 * 
	 * public String getHkTag(String a1, String a2) { HashMap h1=dict.gethk();
	 * Set h2=(Set)h1.get(a1); if (h2 == null) return "0"; if (h2.contains(a2))
	 * return "1"; return "0"; }
	 * 
	 * 
	 * public String getMsrTag(String a1, String a2) { HashMap h1=dict.getmsr();
	 * Set h2=(Set)h1.get(a1); if (h2 == null) return "0"; if (h2.contains(a2))
	 * return "1"; return "0"; }
	 */
