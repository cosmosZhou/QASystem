...
public class Evaluate extends AbstractEvaluate  {
  ...
  final RNNCostAndGradient cag;
  final RNNModel model;

  public Evaluate(RNNModel model) {
    super(model.op);
    this.model = model;
    this.cag = new RNNCostAndGradient(model, null);
  }
  ...
  public static void main(String[] args) {
    ...
    RNNModel model = RNNModel.loadSerialized(modelPath);
