 ...
 * between {@code 0} and {@code maxN - 1} is associated with each keyâ€”the
 * client uses this integer to specify which key to delete or change. It also
 * supports methods for peeking at the minimum key, testing if the priority
...
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
	static public PrintStream StdOut = System.out;
...
//		String[] strings = { "it", "was", "the", "best", "of", "times", "it", "was", "the", "worst" };
		...
		for (int i = 0; i < strings.length; i++) {
			pq.insert(strings.length - 1 - i, strings[i]);
		}
