...
//	public static String MONGO_COLLECTION = PropertyConfig.getProperty("MONGO_COLLECTION", "ecchatrecords");
	...
	public static void static_construct(String MONGO_IP, int MONGO_PORT, String MONGO_DB, String MONGO_COLLECTION){
		MongoDbUtils.MONGO_IP = MONGO_IP;
		MongoDbUtils.MONGO_PORT = MONGO_PORT;
		MongoDbUtils.MONGO_DB = MONGO_DB;
		MongoDbUtils.MONGO_COLLECTION = MONGO_COLLECTION;
	}
	/**
