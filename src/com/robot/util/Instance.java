...
public class Instance implements Serializable {
	...
	public void setClause(Object s) {
		this.clause = s;
...
//			return null;
	...
	public String toString() {
		...
		str += "\n";
		str += "target : " + Utility.toString(target);
		str += "\n";
		str += "clause : " + Utility.toString(clause);
		str += "\n";
		str += "source : " + Utility.toString(source);

		// str += "\n";
		// str += "tempData : " + tempData;
		// str += "\n";
		// str += "dicData : \n";
		// str += Utility.toString(dicData);
		return str;
	}
}
