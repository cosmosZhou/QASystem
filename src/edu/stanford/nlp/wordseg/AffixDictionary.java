 ...
 */
public class AffixDictionary implements Serializable {

	private static final long serialVersionUID = -9005785245270003341L;
	...
	private static Set<String> readDict(String filename) {
		...
		try {
			 ...
			 * aDetectorReader = new BufferedReader(new InputStreamReader(new
			 * FileInputStream(filename), "Big5_HKSCS")); }else{ aDetectorReader
			 * = new BufferedReader(new InputStreamReader(new
			 * FileInputStream(filename), "GB18030")); }
			 */
